<div
    ...
    <div class="h-full flex items-center">
        ...
        <!--Dark Mode-->
        <div class="intro-x dropdown mr-4 sm:mr-6">
            <div class="dropdown-toggle cursor-pointer text-slate-400 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"
                id="theme-toggle" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                <i data-lucide="sun" id="sun-icon" class="notification__icon dark:text-slate-500"></i>
                <i data-lucide="moon" id="moon-icon" class="notification__icon dark:text-slate-500"></i>
            </div>
        </div>
        <!--END: Dark Mode-->
        ...
        <div class="intro-x dropdown w-8 h-8">
            ...
            <div class="dropdown-menu w-56">
                <ul
                    ...
                    <li>
                        <a href="{{ route('profile.change-password') }}" class="dropdown-item hover:bg-white/5"> <i
